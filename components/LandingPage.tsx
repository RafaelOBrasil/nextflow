        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            {[
              ...
              { icon: Star, title: "Link Personalizado", desc: "Tenha um endereço exclusivo para sua barbearia (ex: Next Flow Barber.com/sua-barbearia)." }
            ].map((feature, i) => (
              <motion.div 
                key={i}
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16 md:mb-24">
            ...
            <motion.p 
              ...
              className="text-neutral-500 text-base md:text-xl max-w-2xl mx-auto"
            >
          ...
          <div className="mb-20 md:mb-32">
            <h3 className="text-2xl md:text-4xl font-bold text-center mb-10 md:mb-16">Planos Mensais</h3>
            <motion.div 
              variants={containerVariants}
              initial="hidden"
              whileInView="visible"
            ...
            >
              {plans.filter(p => p.interval === 'month').map((plan) => (
                <motion.div 
                  ...
                  variants={itemVariants}
                  whileHover={{ y: -10 }}
                  className={`bg-white rounded-[2.5rem] p-8 md:p-10 border-2 relative flex flex-col ${
                ...
                >
                  ...
                  <div className="mb-8 md:mb-10">
                    ...
                    <div className="flex items-baseline gap-1.5">
                      ...
                      {plan.price !== 0 && (
                        <span className="text-neutral-500 text-base font-medium">/mês</span>
                      )}
                    </div>
          ...
          {/* Annual Plans */}
          <div>
            <h3 className="text-2xl md:text-4xl font-bold text-center mb-10 md:mb-16">
              Planos Anuais <span className="text-emerald-500 text-lg md:text-2xl ml-2 font-medium">(Economize até 20%)</span>
            </h3>
            <motion.div 
              variants={containerVariants}
              initial="hidden"
              ...
              className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto"
            >
              {plans.filter(p => p.interval === 'year').map((plan) => (
                <motion.div 
                  key={plan.id}
                  variants={itemVariants}
                  whileHover={{ y: -10 }}
                ...
                >
                  ...
                  <div className="mb-8 md:mb-10">
                    ...
                    <div className="flex items-baseline gap-1.5">
                      ...
                      {plan.price !== 0 && (
                        <span className="text-neutral-500 text-base font-medium">/ano</span>
                      )}
                    </div>
                    <p className="text-neutral-500 text-sm mt-3 font-medium">
                      {plan.maxAppointments === null 
